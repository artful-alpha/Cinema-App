    ...
    <div className='item-film'>
      ...
      <div className='film-panel'>
        <div className='film-contro-panel'>
          ...
          <p onClick={()=> isAuth ? addSeeLater() : dispatch(setUpdateModal(true)) } className='film-stars'>★</p>
          <p onClick={()=> isAuth ? addFavorite() : dispatch(setUpdateModal(true)) } className='film-bookmarks'>🏲</p>
        </div>
